...
- Add SPM build checks for Android and Linux
  - Contributed by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#46](https://github.com/space-code/typhoon/pull/46).
...
- Add `.spi.yml`
  - Contributed by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#39](https://github.com/space-code/typhoon/pull/39).
...
### New Contributors
* @renovate[bot] made their first contribution in [#42](https://github.com/space-code/typhoon/pull/42)
